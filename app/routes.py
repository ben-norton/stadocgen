...
def digitalSpecimenGuide():
    ...
    return render_template('quick-reference.html',
                           headerMarkdown=Markup(marked_text),
                           grplists=grplists,
                           pageTitle='Digital Specimen Quick Reference Guide (In Progress)',
...
def digitalMediaGuide():
    ...
    return render_template('quick-reference.html',
                           headerMarkdown=Markup(marked_text),
                           grplists=grplists,
                           pageTitle='Digital Media Quick Reference Guide (In Progress)',
...
def annotationGuide():
    ...
    return render_template('quick-reference.html',
                           headerMarkdown=Markup(marked_text),
                           grplists=grplists,
                           pageTitle='Annotation Quick Reference Guide (In Progress)',
...
def machineAnnotationServiceGuide():
    ...
    return render_template('quick-reference.html',
                           headerMarkdown=Markup(marked_text),
                           grplists=grplists,
                           pageTitle='Machine Annotation Service Quick Reference Guide (In Progress)',
...
def createUpdateTombstoneGuide():
    ...
    return render_template('quick-reference.html',
                           headerMarkdown=Markup(marked_text),
                           grplists=grplists,
                           pageTitle='Create Update Tombstone Event Quick Reference Guide (In Progress)',
...
def dataMappingGuide():
    ...
    return render_template('quick-reference.html',
                           headerMarkdown=Markup(marked_text),
                           grplists=grplists,
                           pageTitle='Data Mapping Quick Reference Guide (In Progress)',
...
def sourceSystemGuide():
    ...
    return render_template('quick-reference.html',
                           headerMarkdown=Markup(marked_text),
                           grplists=grplists,
                           pageTitle='Source System Quick Reference Guide (In Progress)',
...
def digitalSpecimenResources():
    ...
    return render_template('resources.html',
                           ...
                           pageTitle='Digital Specimen Core Resources (In Progress)',
...
def digitalMediaResources():
    ...
    return render_template('resources.html',
                           headerMarkdown=Markup(marked_text),
                           sssomRefMarkdown=Markup(marked_sssom),
                           pageTitle='Digital Media Core Resources (In Progress)',
                           classDiagram=class_diagram,
                           erDiagram=er_diagram,
...
def annotationResources():
    ...
    return render_template('resources.html',
                           headerMarkdown=Markup(marked_text),
                           sssomRefMarkdown=Markup(marked_sssom),
                           pageTitle='Annotation Core Resources (In Progress)',
                           classDiagram=class_diagram,
                           erDiagram=er_diagram,
...
def createUpdateTombstoneEventResources():
    ...
    return render_template('resources.html',
                           headerMarkdown=Markup(marked_text),
                           sssomRefMarkdown=Markup(marked_sssom),
                           pageTitle='Create Update Tombstone Event Resources (In Progress)',
                           classDiagram=class_diagram,
                           erDiagram=er_diagram,
...
def machineAnnotationServiceResources():
    ...
    return render_template('resources.html',
                           headerMarkdown=Markup(marked_text),
                           sssomRefMarkdown=Markup(marked_sssom),
                           pageTitle='Machine Annotation Service Resources (In Progress)',
                           classDiagram=class_diagram,
                           erDiagram=er_diagram,
...
def dataMappingResources():
    ...
    return render_template('resources.html',
                           headerMarkdown=Markup(marked_text),
                           sssomRefMarkdown=Markup(marked_sssom),
                           pageTitle='Mapping Resources (In Progress)',
                           classDiagram=class_diagram,
                           erDiagram=er_diagram,
...
def sourceSystemResources():
    ...
    return render_template('resources.html',
                           headerMarkdown=Markup(marked_text),
                           sssomRefMarkdown=Markup(marked_sssom),
                           pageTitle='Source System Resources (In Progress)',
                           classDiagram=class_diagram,
                           erDiagram=er_diagram,

...
def process_source_mappings():
	...
	# SOURCE FILES
	# dwc_tsv = str(root) + '/mids-reorganization/app/data/source/sssom_dwc_biology_mappings.sssom.tsv'
	dwc_biology_tsv = str(root) + '/mids-reorganization/app/data/source/mids_dwc_biology_1.sssom.tsv'
	dwc_geology_tsv = str(root) + '/mids-reorganization/app/data/source/mids_dwc_geology_1.sssom.tsv'
	abcd_biology_tsv = str(root) + '/mids-reorganization/app/data/source/mids_abcd_biology_1.sssom.tsv'

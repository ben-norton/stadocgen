...
# SOURCE FILES
# dwc_tsv = str(root) + '/mids-reorganization/app/data/source/mids-repo/sssom_dwc_biology_mappings.sssom.tsv'
dwc_biology_tsv = str(root) + '/mids-reorganization/app/data/source/mids-repo/mids_dwc_biology_1.sssom.tsv'
dwc_geology_tsv = str(root) + '/mids-reorganization/app/data/source/mids-repo/mids_dwc_geology_1.sssom.tsv'
abcd_biology_tsv = str(root) + '/mids-reorganization/app/data/source/mids-repo/mids_abcd_biology_1.sssom.tsv'

# TARGET FILES
dwc_biology_sssom = str(root) + '/mids-reorganization/app/data/output/mids-dwc-biology-sssom.tsv'
dwc_biology_unique = str(root) + '/mids-reorganization/app/data/output/mids-dwc-biology-sssom-unique.tsv'
dwc_geology_sssom = str(root) + '/mids-reorganization/app/data/output/mids-dwc-geology-sssom.tsv'
dwc_geology_unique = str(root) + '/mids-reorganization/app/data/output/mids-dwc-geology-sssom-unique.tsv'
abcd_biology_sssom = str(root) + '/mids-reorganization/app/data/output/mids-abcd-biology-sssom.tsv'
abcd_biology_unique = str(root) + '/mids-reorganization/app/data/output/mids-abcd-biology-sssom-unique.tsv'
...
df_dwc_biology['subject_url'] = df_dwc_biology['sssom_subject_id'].str.replace('mids:','https://tdwg.github.io    /mids-reorganization/information-elements#')
...
df_dwc_geology['subject_url'] = df_dwc_geology['sssom_subject_id'].str.replace('mids:','https://tdwg.github.io    /mids-reorganization/information-elements#')
...
df_abcd_biology['subject_url'] = df_abcd_biology['sssom_subject_id'].str.replace('mids:','https://tdwg.github.io    /mids-reorganization/information-elements#')
